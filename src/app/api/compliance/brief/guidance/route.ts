...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const response = await anthropic.messages.create({
      ...
      max_tokens: 4096,
      system: `You are an advertising compliance advisor creating a plain-language compliance brief for a marketing team.
...
INSTRUCTIONS:
Use the generate_guidance tool to produce structured guidance in four categories:
      ...
      tools: [
        {
          ...
          input_schema: {
            ...
            required: ["prohibited", "must", "should", "shouldNot"],
          },
        },
      ],
    });
